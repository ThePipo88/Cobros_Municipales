...
public class AuditorPrincipalController extends Controller{
    ...
    @FXML
    public JFXButton btnTransaccion;
    @FXML
    ...
    public void onActionTransaccion(ActionEvent actionEvent) {
        loadUI("Transacciones");
    }
